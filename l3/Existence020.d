...
public:	
	override string step() {
		...
		Interaction020 enactedInteraction = addOrGetPrimitiveInteraction!Interaction020( experience, result, 0 );
...
protected:
	override void initExistence(){
		...
		addOrGetPrimitiveInteraction!Interaction020(e1, r1, -1);  
		addOrGetPrimitiveInteraction!Interaction020(e1, r2, 1);
		addOrGetPrimitiveInteraction!Interaction020(e2, r1, -1);
		addOrGetPrimitiveInteraction!Interaction020(e2, r2, 1);		
	 ...
	 */
	T addOrGetPrimitiveInteraction(T)( Experiment experience, Result result, int valence ) {
		string label = experience.getLabel() ~ result.getLabel();
		if( label !in INTERACTIONS ){
			T interaction = createInteraction!T( label );
			interaction.setExperience( experience );
			interaction.setResult( result );
			interaction.setValence( valence );
			INTERACTIONS[label] = interaction;
		}
		T interaction = cast(T)INTERACTIONS[label];
		return interaction;
	}
